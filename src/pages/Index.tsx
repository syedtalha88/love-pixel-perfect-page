...
const Nav = () => <header className="sticky top-0 z-40 bg-card/90 backdrop-blur border-b">
...
const Framed = ({
  ...
  alt: string;
    ...
    <img src={src} alt={alt} loading="lazy" className="rounded-sm object-cover w-full h-full" />
  </figure>;
const Index = () => {
  return <>
      ...
      <main className="text-7xl">
        <section id="home" className="relative" style={{
